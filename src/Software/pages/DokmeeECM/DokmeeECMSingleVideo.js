...
const DUMMY_VIDEO = [{
        ...
        about: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente ea sequi dolorum quam? Alias quaerat cum aperiam magni provident molestias.",
        ...
        announcement: [{
                ...
                content: " Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio mollitia voluptate minima earum, architecto magnam corporis minus ipsam, alias quisquam nostrum quam natus vero provident deleniti, est fugit? Impedit, mollitia!",
                date: "01/01/2020",
            },
            {
                id: 2,
...
export default function DokmeeCaptureSingleVideo() {
    ...
    return ( <
        ...
        soft = 'dokmee-ecm'
        tabs = {
            ["Course Description", "Q&A", "Announcement"]
        }
        />
    );
}